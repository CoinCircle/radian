...
abstract contract StdChains {
  ...
  function setChain(string memory chainAlias, Chain memory chain) internal virtual {
    require(
      bytes(chainAlias).length != 0,
      'StdChains setChain(string,Chain): Chain alias cannot be the empty string.'
    );
  ...
  function initialize() private {
    ...
    setChainWithDefaultRpcUrl(
      'mainnet',
      Chain('Mainnet', 1, 'https://mainnet.infura.io/v3/6770454bc6ea42c58aac12978531b93f')
    );
    setChainWithDefaultRpcUrl(
      'goerli',
      Chain('Goerli', 5, 'https://goerli.infura.io/v3/6770454bc6ea42c58aac12978531b93f')
    );
    setChainWithDefaultRpcUrl(
      'sepolia',
      Chain('Sepolia', 11155111, 'https://sepolia.infura.io/v3/6770454bc6ea42c58aac12978531b93f')
    );
    setChainWithDefaultRpcUrl('optimism', Chain('Optimism', 10, 'https://mainnet.optimism.io'));
    setChainWithDefaultRpcUrl(
      'optimism_goerli',
      Chain('Optimism Goerli', 420, 'https://goerli.optimism.io')
    );
    setChainWithDefaultRpcUrl(
      'arbitrum_one',
      Chain('Arbitrum One', 42161, 'https://arb1.arbitrum.io/rpc')
    );
    setChainWithDefaultRpcUrl(
      'arbitrum_one_goerli',
      Chain('Arbitrum One Goerli', 421613, 'https://goerli-rollup.arbitrum.io/rpc')
    );
    setChainWithDefaultRpcUrl(
      'arbitrum_nova',
      Chain('Arbitrum Nova', 42170, 'https://nova.arbitrum.io/rpc')
    );
    setChainWithDefaultRpcUrl('polygon', Chain('Polygon', 137, 'https://polygon-rpc.com'));
    setChainWithDefaultRpcUrl(
      'polygon_mumbai',
      Chain('Polygon Mumbai', 80001, 'https://rpc-mumbai.maticvigil.com')
    );
    setChainWithDefaultRpcUrl(
      'avalanche',
    ...
    setChainWithDefaultRpcUrl(
      'avalanche_fuji',
      Chain('Avalanche Fuji', 43113, 'https://api.avax-test.network/ext/bc/C/rpc')
    );
    setChainWithDefaultRpcUrl(
      'bnb_smart_chain',
      Chain('BNB Smart Chain', 56, 'https://bsc-dataseed1.binance.org')
    );
    setChainWithDefaultRpcUrl(
    ...
    setChainWithDefaultRpcUrl(
      'gnosis_chain',
      Chain('Gnosis Chain', 100, 'https://rpc.gnosischain.com')
    );
  }
