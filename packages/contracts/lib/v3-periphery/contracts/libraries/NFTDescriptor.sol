...
library NFTDescriptor {
  ...
  function generateSVGImage(
    ...
    NFTSVG.SVGParams memory svgParams = NFTSVG.SVGParams({
      ...
      x1: scale(
        getCircleCoord(uint256(params.quoteTokenAddress), 16, params.tokenId),
        0,
        255,
        16,
        274
      ...
      y1: scale(
        getCircleCoord(uint256(params.baseTokenAddress), 16, params.tokenId),
        0,
        255,
        100,
        484
      ...
      x2: scale(
        getCircleCoord(uint256(params.quoteTokenAddress), 32, params.tokenId),
        0,
        255,
        16,
        274
      ...
      y2: scale(
        getCircleCoord(uint256(params.baseTokenAddress), 32, params.tokenId),
        0,
        255,
        100,
        484
      ...
      x3: scale(
        getCircleCoord(uint256(params.quoteTokenAddress), 48, params.tokenId),
        0,
        255,
        16,
        274
      ...
      y3: scale(
        getCircleCoord(uint256(params.baseTokenAddress), 48, params.tokenId),
        0,
        255,
        100,
        484
