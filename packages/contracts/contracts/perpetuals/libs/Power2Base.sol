...
library Power2Base {
    ...
    function _getDenormalizedMark(
        ...
        uint256 perpStablecoinPrice = _getMarkTwap(_marketOracle, _perpStablecoinPool, _perp, _stablecoin, _secondsAgo, false);
     ...
     */
    function _getDebtValueInStablecoin(
        uint256 _debtAmount
    ...
    function _getScaledMarkTwap(
        ...
        uint256 twap = IExchangeOracle(_marketOracle).getTwap(_pool, _base, _quote, _secondsAgo, _checkPeriod);
