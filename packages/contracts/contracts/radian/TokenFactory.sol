...
contract TokenFactory {
    ...
    event TokenCreated(address indexed owner, address indexed token, string name, string symbol, uint256 totalSupply);
    ...
    function isValidPercent(uint256 _percent) pure internal returns (bool) {
    ...
    function getOwnedTokens() view public returns (Token[] memory) {
