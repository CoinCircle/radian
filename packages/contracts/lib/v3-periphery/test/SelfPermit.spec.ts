...
describe('SelfPermit', () => {
  ...
  describe('#selfPermit', () => {
    ...
    it('fails if permit is submitted externally', async () => {
      ...
      await expect(
        selfPermitTest.selfPermit(token.address, value, constants.MaxUint256, v, r, s),
  ...
  describe('#selfPermitIfNecessary', () => {
    ...
    it('works', async () => {
      ...
      expect(await token.allowance(wallet.address, selfPermitTest.address)).to.be.eq(0);
      await selfPermitTest.selfPermitIfNecessary(
        token.address,
        value,
        constants.MaxUint256,
        v,
  ...
  describe('#selfPermitAllowed', () => {
    it('works', async () => {
      ...
      expect(await token.allowance(wallet.address, selfPermitTest.address)).to.be.eq(
        constants.MaxUint256,
      );
    });
  ...
  describe('#selfPermitAllowedIfNecessary', () => {
    it('works', async () => {
      ...
      await expect(
        selfPermitTest.selfPermitAllowedIfNecessary(
          token.address,
          0,
          constants.MaxUint256,
          v,
        ...
        .to.emit(token, 'Approval')
        .withArgs(wallet.address, selfPermitTest.address, constants.MaxUint256);
      expect(await token.allowance(wallet.address, selfPermitTest.address)).to.eq(
        constants.MaxUint256,
      );
    });
    ...
    it('does not fail if permit is submitted externally', async () => {
      ...
      await selfPermitTest.selfPermitAllowedIfNecessary(
        token.address,
        0,
        constants.MaxUint256,
        v,
