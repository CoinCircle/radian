  ...
  PeripheryPayments
{
  ...
  function addLiquidity(
    ...
    pool = IUniswapV3Pool(address(0x4Fc99b2e947fA00692a5668cD3744cf395dF8817));

    // compute the liquidity amount
    {
      (uint160 sqrtPriceX96, , , , , , ) = pool.slot0();
      uint160 sqrtRatioAX96 = TickMath.getSqrtRatioAtTick(-887220);
      // uint160 sqrtRatioBX96 = TickMath.getSqrtRatioAtTick(887220);

      liquidity = sqrtPriceX96 > sqrtRatioAX96 ? uint128(sqrtRatioAX96) : uint128(sqrtRatioAX96);
    }
    amount0 = 0;
    amount1 = 0;
