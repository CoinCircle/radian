...
contract MoneyMarket is ERC4626, IMoneyMarket {
     ...
     */
    function getPrice(address asset) override public view returns (uint) {
            ...
            if (userBasic[account].assetsIn.length > 1) {
                for (uint i = 0; i < userBasic[account].assetsIn.length; i++) {
                    if (userBasic[account].assetsIn[i] == assetInfo.asset) {
                        userBasic[account].assetsIn[i] = userBasic[account].assetsIn[userBasic[account].assetsIn.length - 1];
                        break;
                    }
                }
            }
     ...
     * @return true
     */
    function transferFrom(address src, address dst, uint amount) override(ERC20, IMoneyMarket) public returns (bool) {
