...
The Radian DAO represents the next chapter of our evolution. Through [Snapshot governance](https://snapshot.box/#/s:radiandao.eth), RAD token holders will have direct voting power over:
...
Decentralization is a journey, not a destination. Over the coming months, we'll progressively hand over more control:

1. **Initial governance** - Community input on non-critical parameters
2. **Expanded authority** - DAO control over protocol upgrades
...
*Join the conversation and participate in governance at [snapshot.box/#/s:radiandao.eth](https://snapshot.box/#/s:radiandao.eth)*