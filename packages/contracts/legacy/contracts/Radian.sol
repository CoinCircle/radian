...
contract Radian is Ownable, BurnableToken, StandardToken {
  ...
  function liquidateRAD(address[] tokenAddresses, uint256 amount) public onlyVerified {
  ...
  function removeToken(address tokenAddress, uint256 amount) public onlyOwner {
