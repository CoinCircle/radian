...
contract SwapMathEchidnaTest {
  function checkComputeSwapStepInvariants(
    ...
    (uint160 sqrtQ, uint256 amountIn, uint256 amountOut, uint256 feeAmount) = SwapMath
      .computeSwapStep(sqrtPriceRaw, sqrtPriceTargetRaw, liquidity, amountRemaining, feePips);
