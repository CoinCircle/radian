 ...
 * AMB
 */
contract CrossChainEnabledAMBMockUpgradeable is
  Initializable,
  ReceiverUpgradeable,
 ...
 * Arbitrum
 */
contract CrossChainEnabledArbitrumL1MockUpgradeable is
  Initializable,
  ReceiverUpgradeable,
  CrossChainEnabledArbitrumL1Upgradeable
{
  /// @custom:oz-upgrades-unsafe-allow constructor
...
contract CrossChainEnabledArbitrumL2MockUpgradeable is
  Initializable,
  ReceiverUpgradeable,
  CrossChainEnabledArbitrumL2Upgradeable
{
  function __CrossChainEnabledArbitrumL2Mock_init() internal onlyInitializing {}
 ...
 * Optimism
 */
contract CrossChainEnabledOptimismMockUpgradeable is
  Initializable,
  ReceiverUpgradeable,
  CrossChainEnabledOptimismUpgradeable
{
  /// @custom:oz-upgrades-unsafe-allow constructor
 ...
 * Polygon
 */
contract CrossChainEnabledPolygonChildMockUpgradeable is
  Initializable,
  ReceiverUpgradeable,
  CrossChainEnabledPolygonChildUpgradeable
{
  /// @custom:oz-upgrades-unsafe-allow constructor
