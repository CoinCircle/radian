...
export type Contracts = {
  weth: Types.WETH9;
  uniswapRouter: Types.SwapRouter;
  exchangePoolFactory: Types.ExchangePoolFactory;
  uniswapNFTManager: Types.NonfungiblePositionManager;
  radianX: Types.RadianX;
  radianPaymaster: Types.RadianPaymaster;
};
