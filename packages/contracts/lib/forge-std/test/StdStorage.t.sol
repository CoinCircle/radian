...
contract StdStorageTest is Test {
  ...
  function testStorageDeepMap() public {
    ...
    assertEq(
      uint256(
        keccak256(abi.encode(address(this), keccak256(abi.encode(address(this), uint256(5)))))
      ),
      slot
    );
  }
  ...
  function testStorageDeepMapStructA() public {
    ...
    assertEq(
      bytes32(
        uint256(
          keccak256(abi.encode(address(this), keccak256(abi.encode(address(this), uint256(6)))))
        ) + 0
      ),
      bytes32(slot)
    );
