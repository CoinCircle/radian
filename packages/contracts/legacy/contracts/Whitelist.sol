...
contract Whitelist is Ownable {
    ...
    function setVerified(address targetUser, bool isRegistered)
        public
        onlyOwner
    {
    ...
    function setVerifiedMultiple(address[] targetUsers, bool isRegistered)
        public
        onlyOwner
    {
    ...
    /// @param isRegistered New registration status of the address
    function setAccredited(address targetUser, bool isRegistered)
        public
        onlyOwner
    {
    ...
    /// @param isRegistered New registration status of addresses
    function setAccreditedMultiple(address[] targetUsers, bool isRegistered)
        public
        onlyOwner
    {
        for (uint256 i = 0; i < targetUsers.length; i++) {
    ...
    function setVerifiedAndAccredited(address targetUser, bool isRegistered)
        public
        onlyOwner
    {
    ...
    /// @param isRegistered New registration status of addresses
    function setVerifiedAndAccreditedMultiple(address[] targetUsers, bool isRegistered)
        public
        onlyOwner
    {
        for (uint256 i = 0; i < targetUsers.length; i++) {
    ...
    function swapAddresses(address[] oldAddresses, address[] newAddresses)
        public
        onlyOwner
    {
