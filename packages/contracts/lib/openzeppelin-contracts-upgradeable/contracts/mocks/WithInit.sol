...
contract GovernorTimelockCompoundMockUpgradeableWithInit is
...
contract GovernorCompatibilityBravoMockUpgradeableWithInit is
  GovernorCompatibilityBravoMockUpgradeable
{
  constructor(
    string memory name_,
...
contract ERC721PresetMinterPauserAutoIdUpgradeableWithInit is
...
contract GovernorPreventLateQuorumMockUpgradeableWithInit is
...
contract CheckpointsMockUpgradeableWithInit is CheckpointsMockUpgradeable {
  constructor() payable initializer {
    __CheckpointsMock_init();
  }
}
import './CheckpointsMockUpgradeable.sol';

contract Checkpoints224MockUpgradeableWithInit is Checkpoints224MockUpgradeable {
  constructor() payable initializer {
    __Checkpoints224Mock_init();
  }
}
import './CheckpointsMockUpgradeable.sol';
...
contract ERC721ConsecutiveEnumerableMockUpgradeableWithInit is
...
contract SupportsInterfaceWithLookupMockUpgradeableWithInit is
...
contract ERC4626DecimalMockUpgradeableWithInit is ERC4626DecimalMockUpgradeable {
  constructor(
    IERC20MetadataUpgradeable asset,
    string memory name,
    string memory symbol,
    ...
    __ERC4626DecimalMock_init(asset, name, symbol, decimalsOverride);
  }
}
...
contract CrossChainEnabledAMBMockUpgradeableWithInit is CrossChainEnabledAMBMockUpgradeable {
  constructor(address bridge) payable CrossChainEnabledAMBMockUpgradeable(bridge) initializer {}
}
import './crosschain/receiversUpgradeable.sol';

contract CrossChainEnabledArbitrumL1MockUpgradeableWithInit is
  CrossChainEnabledArbitrumL1MockUpgradeable
{
  constructor(
    address bridge
  ) payable CrossChainEnabledArbitrumL1MockUpgradeable(bridge) initializer {}
}
import './crosschain/receiversUpgradeable.sol';

contract CrossChainEnabledArbitrumL2MockUpgradeableWithInit is
  CrossChainEnabledArbitrumL2MockUpgradeable
{
  constructor() payable initializer {
...
contract CrossChainEnabledOptimismMockUpgradeableWithInit is
  CrossChainEnabledOptimismMockUpgradeable
{
  constructor(
    address bridge
  ) payable CrossChainEnabledOptimismMockUpgradeable(bridge) initializer {}
}
import './crosschain/receiversUpgradeable.sol';

contract CrossChainEnabledPolygonChildMockUpgradeableWithInit is
  CrossChainEnabledPolygonChildMockUpgradeable
{
  constructor(
    address bridge
  ) payable CrossChainEnabledPolygonChildMockUpgradeable(bridge) initializer {}
}
...
contract CrossChainEnabledAMBUpgradeableWithInit is CrossChainEnabledAMBUpgradeable {
  constructor(address bridge) payable CrossChainEnabledAMBUpgradeable(bridge) initializer {}
}
...
contract ERC2771ContextMockUpgradeableWithInit is ERC2771ContextMockUpgradeable {
  ...
  ) payable ERC2771ContextMockUpgradeable(trustedForwarder) initializer {}
}
import './ERC20CappedMockUpgradeable.sol';

contract ERC20CappedMockUpgradeableWithInit is ERC20CappedMockUpgradeable {
  constructor(string memory name, string memory symbol, uint256 cap) payable initializer {
...
contract TimelockControllerWith46MigrationUpgradeableWithInit is
  TimelockControllerWith46MigrationUpgradeable
{
  constructor(
    uint256 minDelay,
    address[] memory proposers,
